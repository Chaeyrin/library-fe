...
import { useLatestBorrowAdmin } from "@/app/api/services/dashboard/queries";
...
export default function InfoCurrentAdmin() {
  const latestBorrowAdmin = useLatestBorrowAdmin();
        ...
        <div className="flex justify-between items-start">
          <div>
            ...
            <p className="text-sm text-gray-400">
              Borrowing requests from current users
            </p>
          </div>
          <Popover>
